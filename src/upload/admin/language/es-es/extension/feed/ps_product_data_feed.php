...
$_['heading_setup']                = 'Configuración de Google Product Data Feed';
...
$_['text_success']                 = 'Éxito: ¡Has modificado el feed de Google Product Data Feed!';
...
$_['text_troubleshot']             = '<ul><li><strong>Las categorías de Google no se muestran:</strong> Asegúrate de haber descargado la última lista de categorías de Google e importado correctamente en tu sistema. Esto es esencial para un mapeo adecuado entre tu tienda y Google Merchant Center.</li><li><strong>No hay salida del feed de productos:</strong> Verifica que la extensión de Google Product Data Feed esté habilitada en el panel de administración de OpenCart. Si está habilitada y aún no ves salida, revisa la configuración de la extensión para detectar posibles errores.</li><li><strong>Los productos no aparecen en Google Merchant Center:</strong> Verifica que tus productos estén correctamente categorizados y que no haya errores en los datos de tus productos. Asegúrate de cumplir con las políticas de Google Merchant Center sobre listados de productos.</li></ul>';
$_['text_faq']                     = '<details><summary>¿Qué es la extensión Google Product Data Feed?</summary><p>La extensión Google Product Data Feed ayuda a los usuarios de OpenCart 3.x a exportar sus datos de productos a Google Merchant Center, mejorando la visibilidad en Google Shopping.</p></details><details><summary>¿Cómo habilito la extensión Google Product Data Feed?</summary><p>Puedes habilitar la extensión desde el panel de administración de OpenCart en la sección de Extensiones. Asegúrate de configurar los ajustes según sea necesario.</p></details><details><summary>¿Puedo personalizar mi feed de productos?</summary><p>Sí, la extensión te permite personalizar varios ajustes, incluyendo el uso de precios sin impuestos y las definiciones fiscales, asegurando que tu feed cumpla con tus necesidades.</p></details><details><summary>¿Por qué no se muestra mi feed de productos en Google Merchant Center?</summary><p>Asegúrate de que la extensión Google Product Data Feed esté habilitada y de que tus categorías de productos estén correctamente asociadas con las categorías de Google. Además, revisa si hay errores en la configuración de tu feed.</p></details>';
...
$_['help_additional_images']       = 'Activar esta opción añadirá imágenes adicionales a su feed de Google Product Data Feed. Tenga en cuenta que habilitar esta opción puede ralentizar el proceso de generación del feed y aumentar el tamaño del archivo XML generado.';

// Error
$_['error_permission']             = 'Advertencia: ¡No tienes permiso para modificar el feed de Google Product Data Feed!';
