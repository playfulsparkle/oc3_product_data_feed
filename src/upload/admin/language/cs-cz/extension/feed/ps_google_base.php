...
$_['heading_setup']                = 'Nastavení Google Base';
...
$_['text_gbc2c_restore']           = 'Před importem asociací kategorie Google Base do kategorií obchodu se ujistěte, že jste vybrali správný obchod pro import. Záložní soubor, který nahráváte (gbc2c_backup_store_x.txt), musí končit ID obchodu (x), do kterého obnovujete.';
