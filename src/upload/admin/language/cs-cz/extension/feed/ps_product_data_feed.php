...
$_['heading_setup']                = 'Nastavení Google Product Data Feed';
...
$_['text_success']                 = 'Úspěch: Úspěšně jste upravili Google Product Data Feed feed!';
...
$_['text_troubleshot']             = '<ul><li><strong>Kategorie Google se nezobrazují:</strong> Ujistěte se, že jste stáhli nejnovější seznam kategorií Google a importovali je do vašeho systému. To je nezbytné pro správné mapování mezi vaším webovým obchodem a Google Merchant Center.</li><li><strong>Žádný výstup produktového feedu:</strong> Ověřte, že je rozšíření Google Product Data Feed povoleno v administračním panelu OpenCart. Pokud je povoleno a stále nevidíte žádný výstup, zkontrolujte nastavení rozšíření na možné chyby konfigurace.</li><li><strong>Produkty se nezobrazují v Google Merchant Center:</strong> Ověřte, že jsou vaše produkty správně kategorizovány a že neexistují chyby v datech vašich produktů. Ujistěte se, že splňujete zásady Google Merchant Center týkající se seznamů produktů.</li></ul>';
$_['text_faq']                     = '<details><summary>Co je rozšíření Google Product Data Feed?</summary><p>Rozšíření Google Product Data Feed pomáhá uživatelům OpenCart 3.x exportovat jejich produktová data do Google Merchant Center, čímž zvyšuje viditelnost na Google Nákupy.</p></details><details><summary>Jak aktivuji rozšíření Google Product Data Feed?</summary><p>Rozšíření můžete aktivovat v administračním panelu OpenCart v sekci Rozšíření. Ujistěte se, že jste nastavili potřebná nastavení.</p></details><details><summary>Mohu si přizpůsobit svůj produktový feed?</summary><p>Ano, rozšíření vám umožňuje přizpůsobit různá nastavení, včetně použití cen bez DPH a definic daně, což zajišťuje, že váš feed splňuje vaše potřeby.</p></details><details><summary>Proč se můj produktový feed nezobrazuje v Google Merchant Center?</summary><p>Ujistěte se, že je rozšíření Google Product Data Feed povoleno a že jsou vaše produktové kategorie správně přiřazeny k kategoriím Google. Dále zkontrolujte, zda v konfiguraci vašeho feedu nejsou žádné chyby.</p></details>';
...
$_['help_additional_images']       = 'Povolením této možnosti přidáte do svého Google Product Data Feed feedu další obrázky. Mějte na paměti, že povolení této funkce může zpomalit proces generování feedu a zvýšit velikost generovaného XML souboru.';

// Error
$_['error_permission']             = 'Upozornění: Nemáte oprávnění upravovat Google Product Data Feed feed!';
