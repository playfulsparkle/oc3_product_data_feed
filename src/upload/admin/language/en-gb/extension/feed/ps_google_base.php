...
$_['text_gbc2c_restore']           = 'Before importing Google Base category to store category associations, please ensure that you have selected the correct store for importing. The backup file you upload (gbc2c_backup_store_x.txt) must end with the store ID (x) of the store you are restoring into.';
