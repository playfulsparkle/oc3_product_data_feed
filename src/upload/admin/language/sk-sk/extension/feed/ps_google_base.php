...
$_['text_gbc2c_restore']           = 'Pred importovaním asociácií kategórií Google Base do kategórií obchodu sa uistite, že ste vybrali správny obchod na import. Záložný súbor, ktorý nahrávate (gbc2c_backup_store_x.txt), musí končiť ID obchodu (x), do ktorého sa údaje obnovujú.';
