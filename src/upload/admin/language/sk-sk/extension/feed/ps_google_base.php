...
$_['text_getting_started']         = '<p><strong>Prehľad:</strong> Rozšírenie "Google Base" pre OpenCart 3.x umožňuje používateľom bez námahy exportovať svoje produkty do <a href="https://merchants.google.com" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> vo formáte XML. Tento zásadný nástroj zvyšuje viditeľnosť produktov na Google Shopping, čím uľahčuje potenciálnym zákazníkom ich objavovanie a nákup.</p><p><strong>Požiadavky:</strong> Na využitie tohto rozšírenia sa uistite, že máte nainštalovaný a nakonfigurovaný OpenCart 3. Okrem toho je potrebný aktívny účet Google Merchant Center na efektívne spravovanie vašich produktových zoznamov.</p>';
