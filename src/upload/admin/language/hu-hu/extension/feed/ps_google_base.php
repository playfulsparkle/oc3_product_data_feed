...
$_['text_getting_started']         = '<p><strong>Áttekintés:</strong> A "Google Base" kiterjesztés az OpenCart 3-hez lehetővé teszi a felhasználók számára, hogy termékeiket könnyedén exportálják a <a href="https://merchants.google.com" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a>be XML formátumban. Ez az alapvető eszköz növeli a termékek láthatóságát a Google Shoppingon, megkönnyítve ezzel a potenciális vásárlók számára a termékek felfedezését és megvásárlását.</p><p><strong>Követelmények:</strong> A kiterjesztés használatához győződjön meg arról, hogy az OpenCart 3.x telepítve és konfigurálva van. Emellett aktív Google Merchant Center fiók szükséges a terméklisták hatékony kezeléséhez.</p>';
