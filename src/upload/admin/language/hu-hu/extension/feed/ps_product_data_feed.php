...
$_['heading_setup']                = 'Google Product Data Feed beállítása';
...
$_['text_success']                 = 'Siker: Sikeresen módosította a Google Product Data Feed feed-et!';
...
$_['text_troubleshot']             = '<ul><li><strong>Google kategóriák nem jelennek meg:</strong> Győződjön meg arról, hogy letöltötte a legfrissebb Google kategóriák listáját, és importálta azokat a rendszerébe. Ez elengedhetetlen a webshop és a Google Merchant Center közötti helyes térképezéshez.</li><li><strong>Nincs termék feed kimenet:</strong> Ellenőrizze, hogy a Google Product Data Feed kiterjesztés engedélyezve van-e az OpenCart admin panelen. Ha engedélyezve van, és még mindig nem lát kimenetet, nézze át a kiterjesztés beállításait, hogy nincs-e hiba a konfigurációban.</li><li><strong>Termékek nem jelennek meg a Google Merchant Centerben:</strong> Ellenőrizze, hogy termékei helyesen kategorizálva vannak-e, és hogy nincsenek-e hibák a termékadataiban. Győződjön meg arról, hogy megfelel a Google Merchant Center terméklistázási irányelveinek.</li></ul>';
$_['text_faq']                     = '<details><summary>Mi az a Google Product Data Feed kiterjesztés?</summary><p>A Google Product Data Feed kiterjesztés segít az OpenCart 3.x felhasználóknak exportálni termékadataikat a Google Merchant Centerbe, növelve ezzel a láthatóságot a Google Shoppingon.</p></details><details><summary>Hogyan tudom engedélyezni a Google Product Data Feed kiterjesztést?</summary><p>A kiterjesztést az OpenCart admin panelen, az Extensions szekció alatt tudja engedélyezni. Győződjön meg arról, hogy a beállításokat szükség szerint konfigurálta.</p></details><details><summary>Testreszabhatom a termék feedemet?</summary><p>Igen, a kiterjesztés lehetővé teszi különböző beállítások testreszabását, beleértve a nettó árak használatát és az adódefiníciókat, biztosítva ezzel, hogy a feed megfeleljen az igényeinek.</p></details><details><summary>Miért nem jelenik meg a termék feedem a Google Merchant Centerben?</summary><p>Győződjön meg arról, hogy a Google Product Data Feed kiterjesztés engedélyezve van, és hogy termékkategóriái helyesen vannak társítva a Google kategóriákhoz. Ezenkívül ellenőrizze, hogy nincsenek-e hibák a feed konfigurációjában.</p></details>';
...
$_['help_additional_images']       = 'Ennek az opciónak az engedélyezésével további képeket adhat hozzá a Google Product Data Feed feedhez. Vegye figyelembe, hogy ez lassíthatja a feed generálási folyamatát, és növelheti a generált XML fájl méretét.';

// Error
$_['error_permission']             = 'Figyelmeztetés: Nincs jogosultsága a Google Product Data Feed feed módosításához!';
