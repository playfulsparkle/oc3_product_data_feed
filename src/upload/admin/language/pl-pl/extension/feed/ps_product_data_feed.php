...
$_['heading_setup']                = 'Konfiguracja Google Product Data Feed';
...
$_['text_success']                 = 'Sukces: Pomyślnie zmodyfikowano kanał Google Product Data Feed!';
...
$_['text_getting_started']         = '<p><strong>Przegląd:</strong> Moduł Google Product Data Feed dla OpenCart w wersji 3.x umożliwia użytkownikom bezproblemowy eksport swoich produktów do <a href="https://merchants.google.com" target="_blank" rel="external noopener noreferrer">Google Merchant Center</a> w formacie XML. To istotne narzędzie zwiększa widoczność produktów w Zakupach Google, ułatwiając potencjalnym klientom łatwiejsze odkrywanie i zakup.</p><p><strong>Wymagania:</strong> Aby móc korzystać z tego rozszerzenia, należy upewnić się, że posiadają Państwo zainstalowane i skonfigurowane oprogramowanie OpenCart w wersji 3.x lub nowszej oraz PHP w wersji 7.3. Dodatkowo, wymagane jest aktywne konto Google Merchant Center do efektywnego zarządzania Państwa ofertami produktów.</p>';
...
$_['help_additional_images']       = 'Włączenie tej opcji doda dodatkowe obrazy do kanału Google Product Data Feed. Może to spowolnić generowanie kanału i zwiększyć rozmiar pliku XML.';

// Error
$_['error_permission']             = 'Ostrzeżenie: Brak uprawnień do modyfikacji kanału Google Product Data Feed!';
