...
$_['text_gbc2c_restore']           = 'The restore process is destructive and will erase the current category associations for the selected store. Please ensure that you have selected the correct store for importing, and that the backup file you upload (gbc2c_backup_store_x.txt) ends with the store ID (x) of the store you are restoring into.';
