...
$_['heading_setup']                = 'Настройка Google Product Data Feed';
...
$_['text_success']                 = 'Успех: Вы успешно изменили ленту Google Product Data Feed!';
...
$_['text_edit']                    = 'Редактировать Google Product Data Feed';
...
$_['text_troubleshot']             = '<ul><li><strong>Категории Google не отображаются:</strong> Убедитесь, что вы загрузили последний список категорий Google и импортировали его в вашу систему. Это необходимо для правильного сопоставления между вашим магазином и Google Merchant Center.</li><li><strong>Нет вывода ленты товаров:</strong> Убедитесь, что расширение Google Product Data Feed включено в панели управления OpenCart. Если оно включено и вы все равно не видите вывода, проверьте настройки расширения на наличие ошибок конфигурации.</li><li><strong>Товары не отображаются в Google Merchant Center:</strong> Убедитесь, что ваши товары правильно классифицированы и что нет ошибок в данных о товарах. Также проверьте, что вы соблюдаете политику Google Merchant Center для размещения товаров.</li></ul>';
$_['text_faq']                     = '<details><summary>Что такое расширение Google Product Data Feed?</summary><p>Расширение Google Product Data Feed помогает пользователям OpenCart 3.x экспортировать данные о своих товарах в Google Merchant Center, улучшая видимость на Google Shopping.</p></details><details><summary>Как включить расширение Google Product Data Feed?</summary><p>Вы можете включить расширение через панель управления OpenCart в разделе "Расширения". Убедитесь, что настроили параметры по мере необходимости.</p></details><details><summary>Могу ли я настроить свою ленту товаров?</summary><p>Да, расширение позволяет настроить различные параметры, включая использование цен до налога и определения налогов, чтобы ваша лента соответствовала вашим требованиям.</p></details><details><summary>Почему моя лента товаров не отображается в Google Merchant Center?</summary><p>Убедитесь, что расширение Google Product Data Feed включено и что ваши товарные категории правильно ассоциированы с категориями Google. Также проверьте наличие ошибок в конфигурации ленты.</p></details>';
...
$_['text_gbc2c_restore']           = 'Перед импортом связей категорий Google Product Data Feed с категориями магазина убедитесь, что вы выбрали правильный магазин для импорта. Файл резервной копии, который вы загружаете (gbc2c_backup_store_x.txt), должен заканчиваться ID магазина (x), в который выполняется восстановление.';
...
$_['help_additional_images']       = 'Включение этой опции добавит дополнительные изображения в ваш фид Google Product Data Feed. Обратите внимание, что это может замедлить процесс генерации фида и увеличить размер создаваемого XML-файла.';

// Error
$_['error_permission']             = 'Предупреждение: У вас нет прав для изменения ленты Google Product Data Feed!';
