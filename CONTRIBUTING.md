...
Thank you for your interest in contributing to the Playful Sparkle Product Data Feed extension! We value contributions from the community to enhance this project for all users. Whether you're fixing bugs, adding features, improving documentation, or translating the extension, your efforts are greatly appreciated.
...
1. Review the [existing issues](https://github.com/playfulsparkle/oc3_product_data_feed/issues) to avoid duplicates, or open a ticket on the [support page](https://support.playfulsparkle.com/).
...
- Validate edge cases, such as different feed configurations or large catalogs.
- Confirm that your changes do not conflict with core OpenCart functionality.
- Verify that the generated product data feed is valid and adheres to the required specifications (e.g., Google Merchant Center, Facebook, etc.).
...
- [GitHub Issues](https://github.com/playfulsparkle/oc3_product_data_feed/issues)
